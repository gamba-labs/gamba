...
const config: DocsThemeConfig = {
  logo: (
    <>
      <img src="/logo.svg" alt="Gamba Logo" />
    </>
  ),
  ...
  head: () => {
    ...
    return (
      <>
        ...
        <link rel="shortcut icon" href={ogConfig.favicon} type="image/svg+xml" />
        <link rel="apple-touch-icon" href={ogConfig.favicon} type="image/svg+xml" />
